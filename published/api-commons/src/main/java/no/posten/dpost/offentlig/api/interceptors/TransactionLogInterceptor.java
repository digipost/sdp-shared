...
import no.posten.dpost.offentlig.api.config.TransaksjonsLogg.Retning;
...
import no.posten.dpost.offentlig.api.representations.SimpleUserMessage;
...
import static no.posten.dpost.offentlig.api.config.TransaksjonsLogg.Type.APPLIKASJONSKVITTERING;
import static no.posten.dpost.offentlig.api.config.TransaksjonsLogg.Type.EBMSFEIL;
import static no.posten.dpost.offentlig.api.config.TransaksjonsLogg.Type.PULLREQUEST;
import static no.posten.dpost.offentlig.api.config.TransaksjonsLogg.Type.TRANSPORTKVITTERING;
import static no.posten.dpost.offentlig.api.config.TransaksjonsLogg.Type.USERMESSAGE;
...
public class TransactionLogInterceptor implements SoapEndpointInterceptor, ClientInterceptor {
	...
	private Type getType(final SimpleUserMessage u) {
		if (u.getAction().equals(ACTION_FORMIDLE)) {
			return USERMESSAGE;
		} else {
