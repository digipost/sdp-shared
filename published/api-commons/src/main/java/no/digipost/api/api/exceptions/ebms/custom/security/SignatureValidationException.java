 ...
 */
package no.digipost.api.api.exceptions.ebms.custom.security;
...
import static no.digipost.api.api.exceptions.ebms.Origin.security;
import static no.digipost.api.api.exceptions.ebms.Severity.failure;
import static no.digipost.api.api.exceptions.ebms.custom.Constants.customSecurityErrorCode;
