...
public class PullRequestSender extends EbmsContextAware implements WebServiceMessageCallback {
    ...
    public PullRequestSender(final EbmsPullRequest pullRequest, final JaxbMarshaller marshaller, final KanBekreftesSomBehandletKvittering tidligereKvitteringSomSkalBekreftes) {
