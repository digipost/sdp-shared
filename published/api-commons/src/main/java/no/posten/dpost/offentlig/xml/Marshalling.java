...
import static no.posten.dpost.offentlig.xml.Schemas.EBMS_SCHEMA;
import static no.posten.dpost.offentlig.xml.Schemas.SBDH_SCHEMA;
import static no.posten.dpost.offentlig.xml.Schemas.SDP_SCHEMA;
import static no.posten.dpost.offentlig.xml.Schemas.XMLDSIG_SCHEMA;
...
public class Marshalling {
	...
	private static Jaxb2Marshaller create(final boolean runAfterPropertiesSet) {
		...
		marshaller.setSchemas(SDP_SCHEMA, SBDH_SCHEMA, EBMS_SCHEMA, XMLDSIG_SCHEMA);
