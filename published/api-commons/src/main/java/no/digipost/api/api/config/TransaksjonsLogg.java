 ...
 */
package no.digipost.api.api.config;
...
import static no.digipost.api.api.config.TransaksjonsLogg.Retning.INNKOMMENDE;
import static no.digipost.api.api.config.TransaksjonsLogg.Retning.UTGÅENDE;
import static no.digipost.api.api.config.TransaksjonsLogg.Type.EBMSFEIL;
import static no.digipost.api.api.config.TransaksjonsLogg.Type.SOAPFAULT;
