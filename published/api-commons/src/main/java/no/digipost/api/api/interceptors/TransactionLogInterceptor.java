...
import no.digipost.api.api.PMode;
...
import no.digipost.api.api.config.TransaksjonsLogg;
import no.digipost.api.api.config.TransaksjonsLogg.Retning;
import no.digipost.api.api.config.TransaksjonsLogg.Type;
import no.digipost.api.api.representations.EbmsContext;
import no.digipost.api.api.representations.Organisasjonsnummer;
import no.digipost.api.api.representations.SimpleStandardBusinessDocument;
import no.digipost.api.api.representations.SimpleUserMessage;
import no.digipost.api.api.security.OrgnummerExtractor;
import no.digipost.api.xml.Constants;
import no.digipost.api.xml.Marshalling;
...
import static no.digipost.api.api.PMode.ACTION_FORMIDLE;
import static no.digipost.api.api.config.TransaksjonsLogg.Type.APPLIKASJONSKVITTERING;
import static no.digipost.api.api.config.TransaksjonsLogg.Type.EBMSFEIL;
import static no.digipost.api.api.config.TransaksjonsLogg.Type.PULLREQUEST;
import static no.digipost.api.api.config.TransaksjonsLogg.Type.TRANSPORTKVITTERING;
import static no.digipost.api.api.config.TransaksjonsLogg.Type.USERMESSAGE;
