...
import static no.digipost.api.api.PMode.ACTION_KVITTERING;
import static no.digipost.api.api.PMode.AGREEMENT_REF;
import static no.digipost.api.api.PMode.PARTY_ID_TYPE;
import static no.digipost.api.api.PMode.SERVICE;
import static no.digipost.api.xml.Constants.USER_MESSAGE_QNAME;
